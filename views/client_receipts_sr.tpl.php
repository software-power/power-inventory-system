    ...
    <div class="center-panel">
        <section class="panel">
            <header class="panel-heading">
                <div class="row">
                    <div class="col-md-3">
                        <h2 class="panel-title">Client Receipts SR</h2>
                        <p class="text-primary"><?= $title ?></p>
                    </div>
                    <div class="col-md-4 col-md-offset-3">
                        <form class=" d-flex justify-content-end align-items-center">
                            <input type="hidden" name="module" value="payments">
                            <input type="hidden" name="action" value="client_receipts_sr">
                            <select id="client" name="clientid" class="form-control" required></select>
                    ...
                    <div class="row mt-md">
                        <div class="col-md-3">
                            <form id="multiple-pay-form" action="<?= url('payments', 'credit_payment') ?>" method="post"
                                ...
                                <input type="hidden" name="receipt_type" value="<?= SalesPayments::RECEIPT_TYPE_SR ?>">
                                <input type="hidden" value="<?= base64_encode(url('payments', 'client_receipts_sr')) ?>" name="redirect">
