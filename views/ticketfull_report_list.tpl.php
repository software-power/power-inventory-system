...
@page {
  ...
  .jobsheet-body{
    ...
    -webkit-box-shadow: -7px 10px 23px -14px rgba(0,0,0,0.45);
  -moz-box-shadow: -7px 10px 23px -14px rgba(0,0,0,0.45);
  box-shadow: -7px 10px 23px -14px rgba(0,0,0,0.45);
  }
...
.col-line-bar,.status-strip-line{
    width: 100%;
    background: black;
    color: white;
    font-size: 17px;
...
.work-done-are .work-details table tr th{
  text-align:left;
}
...
.work-done-are .work-details table tr td ul {
  list-style: none;
  margin: 0;
  padding: 0;
}
.work-done-are .work-details table tr td ul li {
    display: inline-block;
    width:79px;
}
.work-done-are .work-details table tr td ul li:before{
  content: '';
    width: 16px;
    height: 16px;
    border: 1px solid;
...
.work-done-desc p.work-header{
  font-weight:700;
  font-size:14px;
  padding-left:10px;
}
.work-done-desc p.work-desc{
  font-size:13px;
}
</style>
          ...
          <div class="sheet-two">
            <div class="jobsheet-body">
              <div class="sheet-header">
                ...
                <div class="company-details">
                  <ul>
                    ...
                    <li>Tel: 2133039 - Mob: (255) 782769370 | </li>
              ...
              <div class="col-line-bar">
                <div class="line-text">
                  <p><?=$ticketdata['deptname']?></p>
                  <p>TICKET FULL REPORT</p>
                </div>
              </div>
              <div class="status-strip-line" style="background:<?=$ticketdata['statuscolor'];?>"></div>
              <div class="date-serial-bar">
                <div class="date-serial-align">
                  <div class="line-date">Viewing Date: <span><strong><?=date('d-m-Y h:i:s:a', time())?></strong> </span> </div>
                  ...
                  <div class="line-serial"> <span> <strong>Ticket No: <?=$_GET['id'];?></strong> </span> </div>
                </div>
              </div>
                  ...
                  <div class="work-details">
                    <table>
                      ...
                      <tr>
                        ...
                        <td><?if($ticketdata['invoiceno'] == "") echo "Null"; else echo $ticketdata['invoiceno'];?></td>
                      </tr>
                      <tr>
                        <th>Amount</th>
                        <td><?=$ticketdata['invoiceamount'];?></td>
                      </tr>
                      <tr>
                        <th>Time Spent :</th>
                        <td><?if($ticketdata['timespent'] == "")echo "Null"; else echo date('H:i', mktime(0,$ticketdata['timespent']));?></td>
                      </tr>
                    ...
                    <table>
                      ...
                      <tr>
                        <th>Ticket Status</th>
                        <td><?=$ticketdata['statusname'];?></td>
                      </tr>
                      <tr>
                        <th>Spare Part :</th>
                        <td><?if($ticketdata['sparepart'] == "") echo 'Null'; else echo $ticketdata['sparepart'];?></td>
                      </tr>
                      <tr>
                        <th>Spare Part Amount :</th>
                        <td><?=$ticketdata['spareamount'];?></td>
              ...
              <div class="work-align">
                <div class="work-done-are work-done-desc">
                  <p class="work-header">Work Done</p>
                  <p class="work-desc"><?=$ticketdata['remark'];?></p>
                </div>
              </div>

              <?php if ($tecDetails){?>

                <div class="work-aligcn">
                  <div class="work-done-are work-done-overideheight">
                    <div class="work-details">
                      <p>Day report / Mult technician report</p>
                      <table style="width:100%;">
                        ...
                        <?php
                        foreach ($tecDetails as $key => $detail){?>
                          ...
                          <tr>
                            ...
                            <td>
                              <ol>
                                <?php foreach ($detail['name'] as $index => $user){?>
                                  <li><?=$user?></li>
                                <?php }; ?>
                              </ol>
                            </td>
              ...
              <div class="supported-area">
                <table>
                  <tr>
                    ...
                    <td>Assigned Date:</td>
                    <td><strong><?=fDate($ticketdata['assignedon'])?></strong></td>
                  </tr>
                  <tr>
                    <td>Assigned By:</td>
                    <td><strong><?=$ticketdata['assignby']?></strong></td>
                  </tr>
                </table>
                <p class="verified-panel">
                  <span>This ticket is</span>
                  <strong>
                    <?
                    if ($ticketdata['isverified'] == 1) {
                      echo " Verified ";
                    }else {
                      echo " Not verified ";
                    }
