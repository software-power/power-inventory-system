<div class="row mb-md <?= $detail['non_stock'] ? 'non-stock' : '' ?>" style="position: relative;">
    ...
    <div class="col-md-1 pl-none pr-none">
        <input placeholder="Quantity" type="text" class="form-control qty" name="qty[]"
    ...
    <div class="col-md-2 pl-none pr-none" style="position: relative">
        ...
        <input placeholder="Exclusive Price" type="text" class="form-control price" name="price[]" step="0.01"
               oninput="calProductAmount(this)" value="<?= $detail['price'] ?>" min="<?= $detail['min_price'] ?>" data-source="price">
    ...
    <div class="col-md-2 pl-none pr-none" style="position: relative;">
        ...
        <input placeholder="Inclusive Price" type="text" class="form-control incprice" name="incprice[]" min="<?= $detail['min_incprice'] ?>"
