      ...
      <div class="sheet-one">
        <div class="jobsheet-body">
          <div class="sheet-header">
            <div class="logo-bar"> <img src="assets/images/PowerTrack.png" alt="company logo"> </div>
            <div class="company-details">
                <ul>
                  <li>Sabodo Car park Tower 10th Floor | </li>
                  <li>India Street - Dar es salaam | </li>
                  <li>Tel: (255) 222133039 - Mob: (255) 754300441</li>
                  <li>Fax: (255) 222137379 | </li>
                  <li>P.O.Box 8758 - Email: amir@powersecure.co.tz | </li>
                  <li>http//:www.powersecure.co.tz | </li>
          ...
          <div class="for-jobcard-info overide-card-height">
            ...
            <div class="pre-install">
              <p>Pre - Installation Check list</p>
              <ul>
                <li>Vehicle Switch On.</li>
                <li>Any Error Electronic</li>
              </ul>
            </div>
          </div>
            ...
            <div class="work-done-are">
              <div class="work-details">
                <table style="width:100%;height: 149px;">
                  ...
                  <div class='work-done'>Work Done:</div>
                  <tr>
                    <td>Date / Time:</td>
                  ...
                  <tr>
                    ...
                    <td>
                      <span class="spn">All installation vehicle is in proper condition</span>
                      <ul>
                        <li>Yes</li>
                        <li>No</li>
                      </ul>
                  ...
                  <tr>
                    <td>On acceptance fo this Job Completed the vehicle is not liable any malfunction of Vehicle</td>
                    <!-- <td>________________</td> -->
                  </tr>
                </table>
