...
<header class="page-header">
    <? if ($SR_MODE) { ?>
        <h2>Location Sales Report SR</h2>
    <? } else { ?>
        <h2>Location Sales Report</h2>
    <? } ?>
</header>
...
<div class="col-md-12">
    <section class="panel">
        <header class="panel-heading">
            ...
            <? if ($SR_MODE) { ?>
                <h2 class="panel-title">Location Sales Report SR</h2>
            <? } else { ?>
                <h2 class="panel-title">Location Sales Report</h2>
            <? } ?>
