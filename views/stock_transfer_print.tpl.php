...
<head>
    ...
    <title>Stock Transfer <?= $transfer['transferno'] ?></title>
...
<section class="sheet padding-5mm no-height">
    ...
    <div class="heading d-flex justify-content-center">
        <h4 class="text-weight-bold"><u>STOCK TRANSFER</u></h4>
    </div>
    <div class="transfer-info">
        <p class="p-none m-none">Transfer No: <span class="text-weight-bold"><?= $transfer['transferno'] ?></span></p>
        <p class="p-none m-none">From: <span class="text-weight-bold"><?= $transfer['fromlocation'] ?></span></p>
        <p class="p-none m-none">To: <span class="text-weight-bold"><?= $transfer['tolocation'] ?></span></p>
        <p class="p-none m-none">Date: <span class="text-weight-bold"><?= fDate($transfer['doc']) ?></span></p>
        <p class="p-none m-none">Issued By: <span class="text-weight-bold"><?= $transfer['transferby'] ?></span></p>
        ...
        <? } else {
            if ($transfer['approver']) { ?>
                <p class="p-none m-none">Approval Status: <span
                            class="text-weight-bold text-muted"><?= $transfer['approver'] ?>, <?= fDate($transfer['doa']) ?></span>
                </p>
            <? } else { ?>
    ...
    <div class="d-flex justify-content-between">
        <div class="invoice-info">
            <p class="p-none m-none">Remarks: <?= $transfer['description'] ?></p>
