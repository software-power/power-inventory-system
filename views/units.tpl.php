...
<div class="center-panel">
    <section class="panel">
        <header class="panel-heading">
            <div class="row">
                <div class="col-md-3">
                    <h2 class="panel-title">Units Of Measurements</h2>
                </div>
                <div class="col-md-9 d-flex justify-content-end align-items-center">
                    <a href="#unitModal" data-toggle="modal" class="mb-xs mt-xs mr-xs modal-with-zoom-anim btn"><i
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="#unitModal" data-toggle="modal"
                                           data-mode="edit"
                                           data-id="<?= $R['id'] ?>" data-name="<?= $R['name'] ?>"
                                           data-abbr="<?= $R['abbr'] ?>" data-status="<?= $R['status'] ?>"
                                           title="Edit"><i class="fa-pencil fa"></i> Edit</a>
                                        <form action="<?= url('units', 'delete') ?>" method="POST"
                                              onsubmit="return confirm('Do you want to delete this unit?')" style="margin:0;">
    ...
    <div class="modal-dialog modal-dialog-center">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><span class="mode">Add</span> Unit</h4>
            </div>
            <form action="<?= url('units', 'save') ?>" method="POST">
                <div class="modal-body">
                    <div class="form-group">
                        <label>Unit Name</label>
                        <input type="hidden" name="unit[id]" class="unit_id inputs">
    ...
    $(function () {
        $('#unitModal').on('show.bs.modal', function (e) {
            ...
            if (source.data('mode') == 'edit') {
                ...
                $(modal).find('.unit_id').val(source.data('id'));
