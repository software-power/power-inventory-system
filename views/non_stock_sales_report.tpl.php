    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form>
                ...
                <? if ($SR_MODE) { ?>
                <input type="hidden" name="action" value="non_stock_sales_report_sr">
                <? } else { ?>
                <input type="hidden" name="action" value="non_stock_sales_report">
                <? } ?>
        ...
        <section class="panel">
            <header class="panel-heading">
                <div class="panelControl">
                    <a class="btn btn-default" href="#search-modal" data-toggle="modal" title="Filter"> <i class="fa fa-search"></i>
                        Open filter </a>
                    <a class="btn btn-default" href="?module=home&action=index" title="Home"> <i class="fa fa-home"></i> Home</a>
                </div>
                <h2 class="panel-title">
                    <? if ($SR_MODE) { ?>
                        Non Stock Sales report SR
                    <? } else { ?>
