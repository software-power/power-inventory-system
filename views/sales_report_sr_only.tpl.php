    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form>
                ...
                <input type="hidden" name="action" value="sales_report_sr_only">
                ...
                <table class="table table-hover mb-none" style="font-size:10pt;" id="userTable">
                    ...
                    <? foreach ($invoice_list as $index => $R) { ?>
                        <tr>
                            ...
                            <td>
                                <?= $R['clientname'] ?>
                                <span class="d-block text-xs text-muted" title="client mobile no"><i><?= $R['mobile'] ?></i></span>
                            </td>
