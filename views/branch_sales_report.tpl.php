    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form>
                ...
                <? if ($SR_MODE) { ?>
                    <input type="hidden" name="action" value="branch_sales_report_sr">
                <? } else { ?>
                    <input type="hidden" name="action" value="branch_sales_report">
                <? } ?>
...
<div class="col-md-12">
    <section class="panel">
        <header class="panel-heading">
            ...
            <? if ($SR_MODE) { ?>
                <h2 class="panel-title">Branch Sales Report SR</h2>
            <? } else { ?>
                <h2 class="panel-title">Branch Sales Report</h2>
            <? } ?>
