<header class="page-header">
    <h2>Cash Summary User-wise</h2>
</header>
<div class="row d-flex justify-content-center">
    <div class="col-md-10">
        <section class="panel">
            <header class="panel-heading">
                <h2 class="panel-title">Cash Summary User-wise</h2>
            </header>
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-md-10">
                        <form id="search-form" class="m-none d-flex align-items-center">
                            ...
                            <input type="hidden" name="action" value="cash_summary_userwise">
                            <div>From:</div>
                            ...
                            <div class="col-md-10">
                                <table class="table table-bordered table-condensed" style="font-size: 10pt;">
                                    ...
                                    foreach ($b['users'] as $user) { ?>
                                        <tr>
                                            <td style="width: 30%;vertical-align: middle;"><?= $ucount ?>. <?= $user['name'] ?></td>
                                            <td>
                                                <table class="table table-bordered" style="font-size: 9pt;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th style="width: 20%"><?= PaymentMethods::CREDIT_CARD ?></th>
                                                        <th style="width: 20%"><?= PaymentMethods::CASH ?></th>
                                                    ...
                                                    <? foreach ($user['currency'] as $currency => $c) { ?>
                                                        <tr>
                                                            <td><?= $currency ?></td>
                                                            <td><?= $c['count'] ?></td>
                                                            <td class="text-right"><?= $c[PaymentMethods::CREDIT_CARD] ? formatN($c[PaymentMethods::CREDIT_CARD]) : '' ?></td>
                                                            <td class="text-right"><?= $c[PaymentMethods::CASH] ? formatN($c[PaymentMethods::CASH]) : '' ?></td>
                                                            <td class="text-right"><?= $c['total'] ? formatN($c['total']) : '' ?></td>
                                                        </tr>
                                                    <? } ?>
                                                    </tbody>
                                                </table>
