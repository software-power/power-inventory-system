    ...
    <div class="col-md-8">
        <section class="panel">
            <header class="panel-heading">
                ...
                <h2 class="panel-title"><i class="fa fa-money"></i> Salesperson Outstanding Summary</h2>
                <p class="text-primary mt-md"><?= $title ?></p>
            </header>
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-4">
                        <h5>Salesperson Outstanding Summary</h5>
                ...
                <div class="table-responsive mt-md">
                    <table class="table table-hover mb-none" style="font-size:10pt;" id="outstanding-table">
                        ...
                        <tbody>
                        <? $count = 1;
                        foreach ($salespersons as $c) { ?>
                            <tr>
                                <td><?= $count ?></td>
                                <td>
                                    <a href="<?= url('reports', 'overall_sales_outstanding', ['order_invoice_createdby' => $c['userid']]) ?>"
                                       title="view details"><?= $c['salesperson'] ?></a>
                                </td>
