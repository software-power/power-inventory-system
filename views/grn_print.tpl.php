...
<section class="sheet padding-5mm no-height">
    ...
    <div class="d-flex justify-content-between">
        <div class="supplier-info">
            ...
            <p class="p-none m-none">Supplier Invoice No: <span class="text-weight-bold"><?= $grn['invoiceno'] ?></span>
            </p>
            <p class="p-none m-none">Verification Code: <span
                        class="text-weight-bold"><?= $grn['verificationcode'] ?></span></p>
        ...
        <div class="grn-info">
            ...
            <p class="p-none m-none">Currency: <span
                        class="text-weight-bold"><?= $grn['currency_name'] ?> - <?= ucfirst($grn['currency_description']) ?></span>
            </p>
        </div>
    </div>
    <div class="products mt-xlg">
        <table class="table">
            ...
            <tr>
                ...
                <th style="text-align: center;">Rate (<?= $grn['currency_name'] ?>)</th>
                <th style="text-align: center;">VAT %</th>
                <th style="text-align: right;">Purchased Cost (<?= $grn['currency_name'] ?>)</th>
            </tr>
            </thead>
            <tbody>
            <? $count = 1;
    ...
    <div class="totals d-flex justify-content-end">
        <table>
            ...
            <tr>
                ...
                <td><span class="text-weight-bold ml-sm"><?= $grn['currency_name'] ?></span></td>
                <td class="text-right"><span class="text-weight-bold ml-md"><?= formatN($grn['total_amount']) ?></span>
                </td>
            </tr>
            <tr>
                ...
                <td class="text-right"><span
                            class="text-weight-bold ml-md"><?= formatN($grn['grand_vatamount']) ?></span></td>
            </tr>
            <tr>
                <td class="text-right text-weight-bold">Adjustment Amount</td>
                <td><span class="text-weight-bold ml-sm"><?= $grn['currency_name'] ?></span></td>
                <td class="text-right"><span class="text-weight-bold ml-md"><?= formatN($grn['adjustment_amount']) ?></span>
                </td>
            </tr>
            <tr>
                <td class="text-right text-weight-bold">Inclusive Amount</td>
                <td><span class="text-weight-bold ml-sm"><?= $grn['currency_name'] ?></span></td>
                <td class="text-right"><span class="text-weight-bold ml-md"><?= formatN($grn['full_amount']) ?></span>
                </td>
            </tr>
            </tbody>
        </table>
