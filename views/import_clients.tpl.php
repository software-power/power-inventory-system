    ...
    <div class="col-md-4">
        <section class="panel">
            <header class="panel-heading d-flex justify-content-between">
                ...
                <? } else { ?>
                    <h2 class="panel-title">Import Clients</h2>
                    <a href="<?= url('import', 'download_client_template') ?>" class="btn btn-primary btn-sm">Download template</a>
                <? } ?>
            </header>
            <div class="panel-body">
                <? if (isset($upload_result)) { ?>
                    ...
                    <form action="<?= url('import', 'upload_clients') ?>" method="post" enctype="multipart/form-data"
