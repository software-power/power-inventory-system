    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form>
                ...
                <input type="hidden" name="action" value="advanced_stock_report">
...
<div class="col-md-12">
    <section class="panel">
        <header class="panel-heading">
            ...
            <h2 class="panel-title">Advanced Stock Report</h2>
            ...
            <div class="table-responsive">
                <table class="table table-hover mb-none" style="font-size:13px;" id="userTable">
                    ...
                    <tr>
                        ...
                        <th style="text-align:center">Held Qty</th>
                        <th style="text-align:center">Pending Order Qty</th>
                        <th style="text-align:center">Pending Sale Qty</th>
                        <th style="text-align:center">Expecting Stock Qty</th>
                        <th>In Unit</th>
                        <!--                        <th>Bulk Unit</th>-->
                    </tr>
                    </thead>
                    ...
                    foreach ($stocklist as $ins => $list) { ?>
                        <tr class="<?= $list['level'] == 'below' ? 'out-of-stock' : '' ?>"
                            ...
                            <? } ?>
                            <td style="text-align:center"><strong><?= $list['in_stock_qty'] ?></strong></td>
                            <td class="<?= $list['held_stock'] > 0 ? 'bg-rosepink text-white' : '' ?>" style="text-align:center">
                                <strong><?= $list['held_stock'] ?></strong></td>
                            <td style="text-align:center"><strong><?= $list['pending_order'] ?></strong></td>
                            <td style="text-align:center"><strong><?= $list['pending_sale'] ?></strong></td>
                            <td style="text-align:center"><strong><?= $list['expecting_stock'] ?></strong></td>
